...
import Flyweight.TipVozilaNedeljeni;
import FlyweightFactory.TipVozilaFactory;
...
public abstract class IzvorPodataka
{
    ...
    private final TipVozilaFactory tipVozilaFactory = new TipVozilaFactory();
    ...
    private Vozilo nasumicnoVozilo() {
        ...
        switch (tip) {
            case 0:
                return new Auto(new TipVozilaNedeljeni("Skoda", "Octavia", 3));
            case 1:
                return new Autobus(tipVozilaFactory.dohvatiTipVozila("Mercedes", "Citaro", 1), "GSP");
            default:
                return new Tramvaj(tipVozilaFactory.dohvatiTipVozila("Duewag", "GT6", 1), "GSP");
        }
    }
}
