...
public abstract class Izvestaj {
    ...
    public void prikaziEkranskuFormu(Scanner unos, IzvorPodataka ip, Kontroler kon) {
        ...
        while (!kraj) {
            ...
            System.out.println("6) Izaberi ulicu za pregled vozila");
            System.out.println("7) Prvi");
            System.out.println("8) Sledeci");
            System.out.println("9) Prethodni");
            System.out.println("10) Zadnji");
            ...
            switch (izbor) {
                ...
                case "2":
                    ...
                    break;
                case "6":
                    kon.izaberiUlicu(unos);
                    break;
                case "7":
                    System.out.println(kon.prviAuto());
                    break;
                case "8":
                    System.out.println(kon.sledeciAuto());
                    break;
                case "9":
                    System.out.println(kon.prethodniAuto());
                    break;
                case "10":
                    System.out.println(kon.zadnjiAuto());
                    break;
                case "0":
                    kraj = true;
                    break;
