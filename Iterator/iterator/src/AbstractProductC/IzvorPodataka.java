...
public abstract class IzvorPodataka
{
    ...
    public Iterator<Vozilo> getIteratorVozila(Put put) {
        return new ListaIterator<>(put::getVozila);
    }

    public Iterator<Put> getIteratorPuteva() {
        return new ListaIterator<>(this::getPutevi);
    }

    public Iterator<Raskrsnica> getIteratorRaskrsnica() {
        return new ListaIterator<>(this::getRaskrsnice);
    }
