...
public final class JednostavanKontroler extends Kontroler{ // ConcreteHandler (terminal karika)



    public JednostavanKontroler(Izvestaj i1,IzvorPodataka ip1){super(i1,ip1,null); }
