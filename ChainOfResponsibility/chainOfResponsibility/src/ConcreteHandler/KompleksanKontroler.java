...
public final class KompleksanKontroler extends Kontroler{ // ConcreteHandler (terminal karika)


    public KompleksanKontroler(Izvestaj i1,IzvorPodataka ip1){super(i1,ip1,null); }
