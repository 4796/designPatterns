...
public abstract class Izvestaj {
    ...
    public void prikaziEkranskuFormu(Scanner unos, IzvorPodataka ip, Kontroler kon) {
        ...
        while (!kraj) {
            ...
            System.out.println("3) Promeni nacin simulacije");
            ...
            switch (izbor) {
                ...
                case "2":
                    ...
                    break;
                case "3":
                    promeniNacinSimulacije(unos, kon);
                    break;
                case "0":
                    kraj = true;
                    break;
    ...
    private void promeniNacinSimulacije(Scanner unos, Kontroler kon) {
        System.out.println();
        System.out.println("Izaberite nacin simulacije: 1) Jednostavan  2) Kompleksan");
        System.out.print("Izbor: ");
        String izborNacina = unos.nextLine().trim();
        if (izborNacina.equals("2")) {
            kon.setNacinSimulacije(new KompleksnaSimulacija());
            System.out.println("Nacin simulacije promenjen na: Kompleksan.");
        } else {
            kon.setNacinSimulacije(new JednostavnaSimulacija());
            System.out.println("Nacin simulacije promenjen na: Jednostavan.");
        }
    }
